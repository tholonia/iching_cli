...
def load_and_print_description(json_file, key):
    try:
        ...
        with open(json_file, mode='r') as file:
            ...
            vorder8child = data[key]['order8child']
            vorder8parent = data[key]['order8parent']
...
#             st = f"""
# Related to the qabalah, the hexagram with a binary value of |{key}| (traditionally hex #|{vtradnum}|), represents the |{key_class}| aspect of |{vpath}| and the domain of |'{vtype}'|. It corresponds to the '|{vtarot}|' of the Tarot deck, and a theme of '|{vtheme}|', and generally understood as |'{vdescription}'|. Its spiritual influence in the material world is represented by |{vassiah}|."""
