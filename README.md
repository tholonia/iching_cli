...
./post.py PDF|BOOK [--test] # create final PDF for PDF reading or BOOK publishing.  --test uses a smaller dataset
 ```
...
Theses PDF files must be generated from within Photoshop (possibly from their PSD files), or within a word processor
